			...
			<div className='flex'>
				{movies.map((movie) => (
					<div key={movie.id} className='flex-full min-w-0 relative'>
						...
						<div className='hidden lg:inline absolute mt-0 top-0 pt-80 xl:pt-92 left-0 bg-transparent z-20 h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent to-transparent p-10 space-y-5 text-white'>
